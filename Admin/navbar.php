				...
				<ul class="app-menu list-unstyled accordion" id="menu-accordion">
					...
					<li class="nav-item has-submenu">
						...
						<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
							<ul class="submenu-list list-unstyled">
								<li class="submenu-item"><a class="submenu-link" href="add-user.php">Add Admin</a></li>
								<li class="submenu-item"><a class="submenu-link" href="add-student.php">Add Student</a></li>
							</ul>
						</div>
					</li>
					<!--//nav-item-->
					<li class="nav-item has-submenu">
						...
						<div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
							<ul class="submenu-list list-unstyled">
								<li class="submenu-item"><a class="submenu-link" href="quiz-list.php">Quiz List</a></li>
								<li class="submenu-item"><a class="submenu-link" href="quiz-results.php">Quiz Results</a></li>
								<li class="submenu-item"><a class="submenu-link" href="quiz-questions.php">Add Questions</a></li>
								<li class="submenu-item"><a class="submenu-link" href="view-all-questions.php">All Questions</a></li>
							</ul>
						</div>
					</li>
					<!--//nav-item-->
