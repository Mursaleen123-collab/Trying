            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-accordion shadow-sm mb-4">
                    <div class="app-card-header p-4 pb-2  border-0">
                        <h4 class="app-card-title">Registration</h4>
                    </div>
                    <!--//app-card-header-->
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq1-1" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-1">
                                    <div class="accordion-body text-start p4">
                                        ...
                                        First to go on registration and click on add admin the form is show fill the form and
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faq1-heading-2">
                                    ...
                                    <div id="faq1-2" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-2">
                                        <div class="accordion-body text-start p4">
                                            First to go on registration and click on add student the form is show fill the form and
                                            press the add button.
                                        </div>
                                    </div>
                            </div>
                ...
                <div class="app-card app-card-accordion shadow-sm mb-4">
                    <div class="app-card-header p-3">
                        <h4 class="app-card-title">Examination</h4>
                    </div>
                    <!--//app-card-header-->
                    <div class="app-card-body p-4 pt-0">
                        <div id="faq2-accordion" class="faq2-accordion faq-accordion accordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq1-3" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-3">
                                    <div class="accordion-body text-start p4">
                                        First to go on examination and click on quiz list and press the right top conner add
                                        quiz button fill the form and press add button.
                                    </div>
                                </div>
                            </div>
                            <!--//accordion-item-->
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq1-5" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-5">
                                    <div class="accordion-body text-start p4">
                                        First to go on examination and click on add question select the subject, fill the form and
                                        click to add button.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faq1-heading-6">
                                    <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#faq1-6" aria-expanded="false" aria-controls="faq1-6">
                                        How to Edit/Delete any Question?
                                    </button>
                                </h2>
                                <div id="faq1-6" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-6">
                                    <div class="accordion-body text-start p4">
                                        First to go on examination and click on all question and select the subject by view button and
                                        press the edit button if you want to edit questions. if you want to delete questions press the delete
                                        button.
                                    </div>
                                </div>
                            </div>
                ...
                <div class="app-card app-card-accordion shadow-sm mb-4">
                    <div class="app-card-header p-3">
                        <h4 class="app-card-title">Academics</h4>
                    </div>
                    <!--//app-card-header-->
                    <div class="app-card-body p-4 pt-0">
                        <div id="faq3-accordion" class="faq3-accordion faq-accordion accordion">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faq2-heading-1">
                                    <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#faq2-1" aria-expanded="false" aria-controls="faq2-1">
                                        How to Degree Offered?
                                    </button>
                                </h2>
                                <div id="faq2-1" class="accordion-collapse collapse border-0" aria-labelledby="faq2-heading-1">
                                    <div class="accordion-body text-start p4">
                                        First to go on academics and click on degree offered the form is show fill the form and press
                                        the add button.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq2-2" class="accordion-collapse collapse border-0" aria-labelledby="faq2-heading-2">
                                    <div class="accordion-body text-start p4">
                                        First to go on academics and click on course list and download the outline.
                                        if you want to change on available course click on edit, fill the form and
                                        press add button.if you want to add new course press the right top conner
                                        add course button fill the form and press add button.
                                    </div>
                                </div>
                            </div>
                            <!--//accordion-item-->
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faq2-heading-3">
                                    <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#faq2-3" aria-expanded="false" aria-controls="faq2-3">
                                        How to Course Assign?
                                    </button>
                                </h2>
                                <div id="faq2-3" class="accordion-collapse collapse border-0" aria-labelledby="faq2-heading-3">
                                    <div class="accordion-body text-start p4">
                                        First to go on academics and click on course list.
                                        if you want to change on available course click on edit, fill the form and
                                        press add button. if you want to assign new course press
                                        assign button fill the form and press add button.
                                    </div>
                                </div>
                                <!--//accordion-item-->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                                ...
                                <div class="app-card-footer p-4 mt-auto">
                                    <a class="btn app-btn-secondary" href="#">Contact us</a>
                                </div>
                                <!--//app-card-footer-->
                            </div>
                            <!--//app-card-->
